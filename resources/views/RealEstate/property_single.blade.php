@extends('RealEstate.base_layout')
        <!-- /HEADER -->
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="property-agent">
                  <h4 class="title-agent">{{ $property->agent->name }}</h4>
                  ...
                  <ul class="list-unstyled">
                    ...
                    {{-- <li class="d-flex justify-content-between">
                      <strong>Skype:</strong>
                      <span class="color-text-a">{{ $property->agent->name }}</span>
                    </li> --}}
                  </ul>
                  <div class="socials-a">
                    <ul class="list-inline">
                      <li class="list-inline-item">
                        <a href="{{ $property->agent->facebook_link }}">
                          <i class="bi bi-facebook" aria-hidden="true"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="{{ $property->agent->twitter_link }}">
                          <i class="bi bi-twitter" aria-hidden="true"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="{{ $property->agent->instagram_link }}">
                          <i class="bi bi-instagram" aria-hidden="true"></i>
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="{{ $property->agent->linkedin_link }}">
